...
enum EntityType_Type {
  EntityType_Type_GAME = 1,
  EntityType_Type_SESSION = 2,
  EntityType_Type_PLAYER = 3,
  EntityType_Type_ADMINISTRATOR = 4
};
bool EntityType_Type_IsValid(int value);
const EntityType_Type EntityType_Type_Type_MIN = EntityType_Type_GAME;
const EntityType_Type EntityType_Type_Type_MAX = EntityType_Type_ADMINISTRATOR;
...
enum RelationType_Type {
  RelationType_Type_HAS_PLAYER = 1
};
...
enum ActivityType_Type {
  ActivityType_Type_UPDATE = 1,
  ActivityType_Type_PLAY = 2
};
bool ActivityType_Type_IsValid(int value);
const ActivityType_Type ActivityType_Type_Type_MIN = ActivityType_Type_UPDATE;
const ActivityType_Type ActivityType_Type_Type_MAX = ActivityType_Type_PLAY;
const int ActivityType_Type_Type_ARRAYSIZE = ActivityType_Type_Type_MAX + 1;

const ::google::protobuf::EnumDescriptor* ActivityType_Type_descriptor();
inline const ::std::string& ActivityType_Type_Name(ActivityType_Type value) {
  return ::google::protobuf::internal::NameOfEnum(
    ActivityType_Type_descriptor(), value);
}
inline bool ActivityType_Type_Parse(
    const ::std::string& name, ActivityType_Type* value) {
  return ::google::protobuf::internal::ParseNamedEnum<ActivityType_Type>(
    ActivityType_Type_descriptor(), name, value);
}
enum IndexType_Type {
  IndexType_Type_ACTIVE = 1,
  IndexType_Type_PLAYER = 2,
  IndexType_Type_ADMIN = 3
};
bool IndexType_Type_IsValid(int value);
const IndexType_Type IndexType_Type_Type_MIN = IndexType_Type_ACTIVE;
const IndexType_Type IndexType_Type_Type_MAX = IndexType_Type_ADMIN;
...
enum EventType_Type {
  EventType_Type_CREATE_GAME = 1,
  EventType_Type_UPDATE_GAME = 2,
  EventType_Type_DELETE_GAME = 3,
  EventType_Type_CREATE_SESSION = 4,
  EventType_Type_UPDATE_SESSION = 5,
  EventType_Type_JOIN_SESSION = 6,
  EventType_Type_LEAVE_SESSION = 7,
  EventType_Type_KICK_PLAYER = 8,
  EventType_Type_PLAY_MOVE = 9,
  EventType_Type_PLAY_XXXXXX = 9,
  EventType_Type_CREATE_PLAYER = 10,
  EventType_Type_UPDATE_PLAYER = 11,
  EventType_Type_DELETE_PLAYER = 12,
  EventType_Type_BLOCK_PLAYER = 13
};
bool EventType_Type_IsValid(int value);
const EventType_Type EventType_Type_Type_MIN = EventType_Type_CREATE_GAME;
const EventType_Type EventType_Type_Type_MAX = EventType_Type_BLOCK_PLAYER;
const int EventType_Type_Type_ARRAYSIZE = EventType_Type_Type_MAX + 1;

const ::google::protobuf::EnumDescriptor* EventType_Type_descriptor();
inline const ::std::string& EventType_Type_Name(EventType_Type value) {
  return ::google::protobuf::internal::NameOfEnum(
    EventType_Type_descriptor(), value);
}
inline bool EventType_Type_Parse(
    const ::std::string& name, EventType_Type* value) {
  return ::google::protobuf::internal::ParseNamedEnum<EventType_Type>(
    EventType_Type_descriptor(), name, value);
}
// ===================================================================
...
class EntityType : public ::google::protobuf::Message {
 public:
  ...
  static const Type ADMINISTRATOR = EntityType_Type_ADMINISTRATOR;
...
class ActivityType : public ::google::protobuf::Message {
 public:
  ActivityType();
  virtual ~ActivityType();

  ActivityType(const ActivityType& from);

  inline ActivityType& operator=(const ActivityType& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const ActivityType& default_instance();

  void Swap(ActivityType* other);

  // implements Message ----------------------------------------------

  ActivityType* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const ActivityType& from);
  void MergeFrom(const ActivityType& from);
  void Clear();
  bool IsInitialized() const;
  ...
  typedef ActivityType_Type Type;
  static const Type UPDATE = ActivityType_Type_UPDATE;
  static const Type PLAY = ActivityType_Type_PLAY;
  static inline bool Type_IsValid(int value) {
    return ActivityType_Type_IsValid(value);
  }
  static const Type Type_MIN =
    ActivityType_Type_Type_MIN;
  static const Type Type_MAX =
    ActivityType_Type_Type_MAX;
  static const int Type_ARRAYSIZE =
    ActivityType_Type_Type_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor*
  Type_descriptor() {
    return ActivityType_Type_descriptor();
  }
  static inline const ::std::string& Type_Name(Type value) {
    return ActivityType_Type_Name(value);
  }
  static inline bool Type_Parse(const ::std::string& name,
      Type* value) {
    return ActivityType_Type_Parse(name, value);
  }

  // accessors -------------------------------------------------------

  // @@protoc_insertion_point(class_scope:ocean.ActivityType)
 private:
  ...
  void InitAsDefaultInstance();
  static ActivityType* default_instance_;
};
// -------------------------------------------------------------------
...
class IndexType : public ::google::protobuf::Message {
 public:
  ...
  static const Type ACTIVE = IndexType_Type_ACTIVE;
...
class EventType : public ::google::protobuf::Message {
 public:
  ...
  typedef EventType_Type Type;
  static const Type CREATE_GAME = EventType_Type_CREATE_GAME;
  static const Type UPDATE_GAME = EventType_Type_UPDATE_GAME;
  static const Type DELETE_GAME = EventType_Type_DELETE_GAME;
  static const Type CREATE_SESSION = EventType_Type_CREATE_SESSION;
  static const Type UPDATE_SESSION = EventType_Type_UPDATE_SESSION;
  static const Type JOIN_SESSION = EventType_Type_JOIN_SESSION;
  static const Type LEAVE_SESSION = EventType_Type_LEAVE_SESSION;
  static const Type KICK_PLAYER = EventType_Type_KICK_PLAYER;
  static const Type PLAY_MOVE = EventType_Type_PLAY_MOVE;
  static const Type PLAY_XXXXXX = EventType_Type_PLAY_XXXXXX;
  static const Type CREATE_PLAYER = EventType_Type_CREATE_PLAYER;
  static const Type UPDATE_PLAYER = EventType_Type_UPDATE_PLAYER;
  static const Type DELETE_PLAYER = EventType_Type_DELETE_PLAYER;
  static const Type BLOCK_PLAYER = EventType_Type_BLOCK_PLAYER;
  static inline bool Type_IsValid(int value) {
    return EventType_Type_IsValid(value);
  }
  static const Type Type_MIN =
    EventType_Type_Type_MIN;
  static const Type Type_MAX =
    EventType_Type_Type_MAX;
  static const int Type_ARRAYSIZE =
    EventType_Type_Type_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor*
  Type_descriptor() {
    return EventType_Type_descriptor();
  }
  static inline const ::std::string& Type_Name(Type value) {
    return EventType_Type_Name(value);
  }
  static inline bool Type_Parse(const ::std::string& name,
      Type* value) {
    return EventType_Type_Parse(name, value);
  }

  // accessors -------------------------------------------------------

  // @@protoc_insertion_point(class_scope:ocean.EventType)
 private:
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::ocean::ActivityType_Type>() {
  return ::ocean::ActivityType_Type_descriptor();
}
template <>
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::ocean::EventType_Type>() {
  return ::ocean::EventType_Type_descriptor();
}
