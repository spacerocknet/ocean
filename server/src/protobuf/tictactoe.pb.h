...
class Player : public ::google::protobuf::Message {
 public:
  ...
  static ::google::protobuf::internal::ExtensionIdentifier< ::model::Entity,
    ...
    PLAYER;
  // @@protoc_insertion_point(class_scope:tictactoe.Player)
 private:
...
class Session : public ::google::protobuf::Message {
 public:
  ...
  static ::google::protobuf::internal::ExtensionIdentifier< ::model::Entity,
    ...
    SESSION;
  // @@protoc_insertion_point(class_scope:tictactoe.Session)
 private:
...
class Game : public ::google::protobuf::Message {
 public:
  ...
  static ::google::protobuf::internal::ExtensionIdentifier< ::model::Entity,
    ...
    GAME;
  // @@protoc_insertion_point(class_scope:tictactoe.Game)
 private:
  inline void set_has_name();
  inline void clear_has_name();
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::tictactoe::Player_State>() {
  return ::tictactoe::Player_State_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::tictactoe::Session_State>() {
  return ::tictactoe::Session_State_descriptor();
}
